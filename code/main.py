...
parser = argparse.ArgumentParser(
    description='Official implementation of `Self-Taught Metric Learning without Labels`'
...
parser.add_argument(
    '--embedding_size', default=512, type=int,
    help='Size of embedding that is appended to backbone model.'
)
parser.add_argument(
    '--bg_embedding_size', default=1024, type=int,
    help='Size of embedding that is appended to backbone model.'
)
parser.add_argument(
...
parser.add_argument(
    '--model', default='bn_inception',
    help='Model for training'
)
parser.add_argument(
    '--optimizer', default='adamp',
...
parser.add_argument(
    '--emb-lr', default=1e-4, type=float,
    help='Learning rate for embedding layer'
)
parser.add_argument(
    '--fix_lr', default=False, type=utils.bool_flag,
...
parser.add_argument(
    '--num_neighbors', default=5, type=int,
    help='For balanced sampling, the number of neighbors per query'
)
parser.add_argument(
    '--bn_freeze', default=0, type=int,
    help='Batch normalization parameter freeze'
)
parser.add_argument(
    '--student_norm', default=0, type=int,
    help='student L2 normalization'
)
parser.add_argument(
    '--teacher_norm', default=1, type=int,
    help='teacher L2 normalization'
)
parser.add_argument(
    '--save', default=True, type=utils.bool_flag,
...
parser.add_argument(
    '--view', default=2, type=int,
    help='choose augmentation view'
)
parser.add_argument(
    '--delta', default=1, type=float,
...
parser.add_argument(
    '--momentum', default=0.999, type=float,
    help='Momentum Update Parameter'
)
parser.add_argument(
    '--pretrained', default=True, type=utils.bool_flag,
    help='Training with ImageNet pretrained model'
)
parser.add_argument(
    '--swav', default=False, type=utils.bool_flag,
